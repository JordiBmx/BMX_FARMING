    ...
    while true do
        ...
        if hasjob then
            if not DoesBlipExist(startBlip) then
                startBlip = addBlip(Config.JobCenter, 514, 0, Strings['blip'])
            end
        else
        ...
        if distance <= 25.0 and hasjob then
            ...
            if distance <= 1.5 then
                ...
                ShowFloatingHelpNotification("Presiona ~g~[E]~s~ para hacer algún trabajo de granjero", vector3(751.69, 6459.21, 32.38))
